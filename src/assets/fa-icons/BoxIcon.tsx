...
const BoxIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" ref={ref} {...props}>
...
const ForwardRef = forwardRef(BoxIcon);
